...
schedule <- tibble(
  DATE = c("1", "2"),
  TITLE = c("Course Introduction", "Descriptive Statistics"),
  `CLASS SLIDES` = c("index.html"),
  `SESSION SCRIPTS` = c(""),
  ASSIGNMENTS = c("")
) |> 
  mutate(
    `CLASS SLIDES` = if_else(`CLASS SLIDES` != "", 
                      paste0("<a href=\"http://localhost:3933/content/", `CLASS SLIDES`, "\">", as.character(fa("book")), "</a>"),
