...
The ways of describing your data depend on the type of variable. You can have categorical or continuous variables. **Categorical variables** are discrete. They can be unordered (**nominal**) - for example, the colour of cars - or ordered (**ordinal**) - for example, whether you strongly dislike, dislike, are neutral about, like, or strongly like Taylor Swift.
...
Normally distributed values *have the same <span style="color:#EEABC4;">mean</span> and <span style="color:#4582EC;">median</span>*.
...
For right skewed data, *the <span style="color:#EEABC4;">mean</span> is greater than the <span style="color:#4582EC;">median</span>*.
...
For left skewed data, *the <span style="color:#EEABC4;">mean</span> is smaller than the <span style="color:#4582EC;">median</span>*.
