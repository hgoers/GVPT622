...
This is an ordinal categorical variable. It is discrete but represents and ordered. We can take a look at the variable itself using the helpful `skimr::skim()` function: 
...
::: {.callout-caution label="Exercise"}
