...
You will need access to the following R packages to complete this week's activities:

::: {.callout-tip collapse="true"}
## Installing packages
If you have not already done so, please install or update them by running the following:
