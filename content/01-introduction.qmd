...
{{< fa arrow-up-right-from-square >}} [Quarto introductory tutorial](https://quarto.org/docs/get-started/hello/rstudio.html)
...
Here is the link for a [great Markdown tutorial](https://www.markdowntutorial.com/). It takes about 10 minutes to complete, so we will play around in there now. 
