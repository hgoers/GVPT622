...
```{r}
datasummary_crosstab(atop_defense ~ dem_dyad, 
...
obs_values <- count(alliance_df, atop_defense, dem_dyad, name = "obs_n")
obs_values
...
alliance_totals <- count(alliance_df, atop_defense, name = "defense_total")
alliance_totals
...
```{r}
chisq.test(alliance_df$atop_defense, alliance_df$dem_dyad)
```
