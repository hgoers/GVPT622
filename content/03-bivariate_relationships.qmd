...
{{< fa book >}} Pollock & Edwards, Chapter 3

### Lab

{{< fa book >}} Pollock & Edwards R Companion, Chapters 4-5

## Class slides

```{=html}
<iframe class="slide-deck" src="../files/slides/Lecture 3- Relationships between Variables-1.pdf" width = "100%" height = 600px></iframe>
```
